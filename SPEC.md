...
> PRD v1 — 5 Sep 2026. Disusun AI-assisted (spec-driven workflow; file ini di-commit sebagai bukti atribusi AI sesuai aturan ETHGlobal).
...
**User persona:** (1) **Investor** — wallet yang ingin menerima/mengirim KPON; (2) **Registrar** — penerbit yang grant/revoke identity claim & menerbitkan token; (3) **Regulator/pengamat** — melihat audit trail rule-by-rule.

**Success =** demo 4 babak berjalan mulus di testnet + submission lengkap sebelum 13 Sep 23.00 WIB:

1. Wallet tanpa claim menerima KPON → **revert dengan nama rule yang dilanggar** (R1-RESIDENCY)
...
- Out of scope Fase 1 (pull-forward): Privy embedded wallet, Uniswap v4 hook, Foundry, ERC-4626/NAV
...
- [ ] 3 fuzz invariant lulus (seed reproducible); core tests lulus di CI lokal
